...
TLINK = INLINE_PIC or "https://telegra.ph/file/7b0b9312a3ac832e9b597.jpg"
...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/ikibotz/botzki"),
        Button.url("• Support •", url="t.me/wibulegend01"),
    ],
]
...
async def inline_alive(o):
    ...
    WEB0 = InputWebDocument(
        "https://telegra.ph/file/7b0b9312a3ac832e9b597.jpg", 0, "image/jpg", []
    )
    RES = [
